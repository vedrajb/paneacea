...
const bindings: [string, string, string, Action][] = [
  ["Tab", "Tab", "Ctrl", "Terminal.NextTab"],
  ["Tab", "Tab", "Ctrl+Shift", "Terminal.PreviousTab"],
  ["Tab", "Tab", "Ctrl+Alt", "Workspace.Next"],
  ["Tab", "Tab", "Ctrl+Alt+Shift", "Workspace.Previous"],
  ...
  ["+", "Equal", "Ctrl+Shift", "Terminal.IncreaseFontSize"],
  ["+", "NumpadAdd", "Ctrl", "Terminal.IncreaseFontSize"],
  ["+", "NumpadAdd", "Ctrl+Shift", "Terminal.IncreaseFontSize"],
  ["-", "Minus", "Ctrl", "Terminal.DecreaseFontSize"],
  ["_", "Minus", "Ctrl+Shift", "Terminal.DecreaseFontSize"],
  ["-", "NumpadSubtract", "Ctrl", "Terminal.DecreaseFontSize"],
  ["-", "NumpadSubtract", "Ctrl+Shift", "Terminal.DecreaseFontSize"],
  ["?", "Slash", "Ctrl+Shift", "Help.ShowShortcuts"],
  ["T", "KeyT", "Ctrl+Shift", "Terminal.NewTab"],
